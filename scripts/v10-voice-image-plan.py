#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v10 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = 'f56a9050f65b995cd5f3f4eead87b17fdc7547e5'
APP_TREE = 'd851260091ba999cdb61852fb7f1da1db813feca'
APP_EPOCH = 1790350723
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v10'
