#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v11 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = 'bf81d55a7d9b84c695a99ee120bfbf001f8ca8f7'
APP_TREE = 'c69221be0dcdea81e05f6c1d8052aa200dd32445'
APP_EPOCH = 1790352709
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v11'
