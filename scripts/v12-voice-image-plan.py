#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v12 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = 'd4c0444acb01d64dfa1f2e820353f73a5b176e00'
APP_TREE = '8a7d1bfdf60915ead98e226fcc33b3a899990c5c'
APP_EPOCH = 1790356109
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v12'
