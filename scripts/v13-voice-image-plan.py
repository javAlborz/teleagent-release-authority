#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v13 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = '1389d6e22e60481bf23f04078ff4d9f7ad233dd0'
APP_TREE = '0cb07412ca1b34e4cc9ee19a06387804f1c4ac90'
APP_EPOCH = 1790359914
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v13'
