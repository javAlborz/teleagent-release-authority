#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v15 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = 'a0c6ff7aa6c20fcbe6c24b39338e04614a54d8d7'
APP_TREE = '4742d2cb97b63440b06df0b98f93a47cc064b211'
APP_EPOCH = 1790365625
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v15'
