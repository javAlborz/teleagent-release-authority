#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v16 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = 'f4e563203a49ae5c70e5114a695a42b770b37f78'
APP_TREE = '19c7f3dcaac8279bdf28fd8451cdf1d60bf02df2'
APP_EPOCH = 1790410183
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v16'
