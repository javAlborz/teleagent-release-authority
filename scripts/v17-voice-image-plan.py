#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v17 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = '52bda261c37993beedb58ae290c9e6a27d28a948'
APP_TREE = 'f47c54476f022816ba62ca3ed1379bf0ed804bab'
APP_EPOCH = 1790413394
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v17'
