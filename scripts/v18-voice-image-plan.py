#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v18 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = 'bd40b6b64e63fa42e43dee7df179555bd51645cc'
APP_TREE = 'fb7c11a7a62f178547a042c86aba255ecbaf2790'
APP_EPOCH = 1790416614
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v18'
