#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v19 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = '8485f8000ba986ebc53210350add23078d970931'
APP_TREE = '8b91872efc76d56a0efafe17e8e1c3933708af5a'
APP_EPOCH = 1790419537
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v19'
