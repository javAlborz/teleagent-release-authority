#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v20 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = '13024c12acd8c4c13e3c30ad15caa9ced03a351c'
APP_TREE = 'c0b4356f9f15d163800fc731af5d516a8ae6c287'
APP_EPOCH = 1790422432
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v20'
