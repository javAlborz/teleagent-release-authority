#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v21 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = '067dd51e2acef87f5704e4945694f14bfbfaffcd'
APP_TREE = 'cbbcefcd13a60d3f29fa6d81de9f5b01f043f7ff'
APP_EPOCH = 1790425194
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v21'
