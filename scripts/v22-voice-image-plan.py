#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v22 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = 'd8ef1bdf60b48d393ed642305d92587dfa32e240'
APP_TREE = '6ea68df4be14d9e7f4fbf0020c7cd6ec046f2a05'
APP_EPOCH = 1790428897
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v22'
