#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v23 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = '2110e614c9050801b066e277fa69828b19bce094'
APP_TREE = '01874ad5d798f04d4efede58a52cc0003729d399'
APP_EPOCH = 1790433120
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v23'
