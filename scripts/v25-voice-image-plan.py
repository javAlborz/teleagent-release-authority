#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v25 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = '38542697a44b5314b6cfe73d17f7f7548ff57bf6'
APP_TREE = '9165e2dc3b3d158bb95c11cf82a68a71e85a8ead'
APP_EPOCH = 1790442009
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v25'
