#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v27 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = 'f4113fca8d5fcffa2f1aba5cd5f015b8725710af'
APP_TREE = '08e7e953e5feafa2b03df9ff9b9aa90e03499aba'
APP_EPOCH = 1790447700
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v27'
