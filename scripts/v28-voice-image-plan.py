#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v28 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = 'cc0de4f31dd1de55c587dd0ee7448847df870fc9'
APP_TREE = '4a516d42a434c136242dffdff440e75f15a27d93'
APP_EPOCH = 1790455845
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v28'
