#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v29 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = 'f50a02d0f76e2d20d82098c806965e602ee46130'
APP_TREE = 'e581e4ee3de938e495a44d9fa7a338273b26f555'
APP_EPOCH = 1790460337
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v29'
