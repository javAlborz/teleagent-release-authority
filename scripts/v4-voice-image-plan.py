#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v4 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = 'f711007f9b71b83a721617d04118630253125afa'
APP_TREE = 'afae577b0fead7346a8f5e6624e241e7d2c8b497'
APP_EPOCH = 1790331641
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v4'
