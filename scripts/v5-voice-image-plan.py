#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v5 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = 'a256435586df2c5a403e9cb9b5cde98eab498448'
APP_TREE = 'dd695a2f7a9011ef42b48d433a923abf675644d7'
APP_EPOCH = 1790335395
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v5'
