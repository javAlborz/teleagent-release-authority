#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v6 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = '6ce710e13fffbe4d4407fc3326e8ed4bd7ff09c0'
APP_TREE = 'd115771b63097ceda312d1cb69bab1025e76b3ce'
APP_EPOCH = 1790337012
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v6'
