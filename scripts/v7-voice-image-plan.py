#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v7 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = 'a9c4ef96626a35d994b9f180d6029d411133ccbb'
APP_TREE = 'e47f86be4e1953e5012c0119011f1bd70e1d0289'
APP_EPOCH = 1790342072
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v7'
