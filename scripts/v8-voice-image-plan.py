#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v8 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = '31d8b94138e5abcc696939b62f435f81abc07910'
APP_TREE = '67adbf6242ffa8e79feafd3986d4202f413c6e62'
APP_EPOCH = 1790345634
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v8'
