#!/usr/bin/python3 -I
"""Emit the fixed, unsigned v9 voice-image build recipe as data only."""
import hashlib
import json
import sys

APP_REVISION = 'e8a3e8d80f368e00f17d20524e319d0fc7d4187b'
APP_TREE = '309374db64f7f661fe09c28d26b47f88981163d1'
APP_EPOCH = 1790347860
...
PLAN_SCHEMA = 'teleagent.offline-voice-image-plan.v9'
