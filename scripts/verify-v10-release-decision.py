#!/usr/bin/python3 -I
"""Verify the exact v10 Teleagent release evidence before authority signing.
...
APP = 'f56a9050f65b995cd5f3f4eead87b17fdc7547e5'
TREE = 'd851260091ba999cdb61852fb7f1da1db813feca'
BUNDLE_SHA = 'b459f6c895703d7bebe5bd41fab16124c28f7b11b5dcee04137acc893240fee2'
BUNDLE_SIZE = 840325120
MANIFEST_SHA = '5dfdeba015efd647a55e8b9f458b194ca24ba73c523528091bd4ea0679155b0b'
VOICE_SHA = 'b4ef5a553ba755983f6998c234e79267882862ce0c4e34d81f36c60c7184e5ca'
VOICE_CONFIG = 'sha256:766495106e4291dc6e44ae3848d4d8389ce2142b78116be8e2b73d07e978fa70'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = 'baf91e874d7a6fbfd1e3ac1c32f21cefbba448b7da8f160b39d9b063c5125579'
SCAN_CHECK_SHA = 'c8250875e62a4105dbe3694647fd51960fd7cf7d90436e4faea239eb0297b3af'
DB_METADATA_SHA = '3535cda3f069caeea2192b5f7f88b23fa2f592cb5773e65513e43a731018ed9b'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v10-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36155623481,
    'voiceSbom': 36155790967,
    'bundle': 36155903127,
    'freshScan': 36155791066,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': '9222ac9f9ca58a1c0d242b10735626704e74b927ebcb616576453b9f28c7e591',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v10-voice-scan.py')
