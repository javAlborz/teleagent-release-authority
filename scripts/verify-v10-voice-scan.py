#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v10 hosted voice image.
...
IMAGE_SHA256 = 'b4ef5a553ba755983f6998c234e79267882862ce0c4e34d81f36c60c7184e5ca'
APP_REVISION = 'f56a9050f65b995cd5f3f4eead87b17fdc7547e5'
IMAGE_NAME = 'teleagent-v10-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v10-voice-diagnostic:20260925'],
             'image tag differs')
