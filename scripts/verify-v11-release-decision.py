#!/usr/bin/python3 -I
"""Verify the exact v11 Teleagent release evidence before authority signing.
...
APP = 'bf81d55a7d9b84c695a99ee120bfbf001f8ca8f7'
TREE = 'c69221be0dcdea81e05f6c1d8052aa200dd32445'
BUNDLE_SHA = '3cbb5ba5ef41230ed15e82b27b6c718f7facf64d8c35a2501f9d839b5252a96c'
BUNDLE_SIZE = 840325120
MANIFEST_SHA = '210c9e5391c4c4dfd4512185900c9e88796d43495e17c5f737d6ac6433026c0c'
VOICE_SHA = '0c7916bc8c9e6c262991c25088aa209d4e452882014ba3bc729667b55bcc4844'
VOICE_CONFIG = 'sha256:d80528208ec90974298a25a02a32ed40164423c9e0883c6a5e3be7203e18b434'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = '4f6595af1bee1e8a3829d49a5159420797759e083bda1598b1584a9bfebbcc49'
SCAN_CHECK_SHA = 'fc57ff7a21ea821e44e45251dabef139195c85132ea22ad5cadbdc88468fb9e7'
DB_METADATA_SHA = 'c795fc3c5fa6387f58f344fe04ac5839856474a976013ff1ce2a6566f6fd31b8'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v11-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36159290820,
    'voiceSbom': 36159422712,
    'bundle': 36159517220,
    'freshScan': 36159422789,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': 'f079e8179fc08f4f6c6210956329790e1c8f8585028f67b267e7704fb9b998d6',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v11-voice-scan.py')
