#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v11 hosted voice image.
...
IMAGE_SHA256 = '0c7916bc8c9e6c262991c25088aa209d4e452882014ba3bc729667b55bcc4844'
APP_REVISION = 'bf81d55a7d9b84c695a99ee120bfbf001f8ca8f7'
IMAGE_NAME = 'teleagent-v11-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v11-voice-diagnostic:20260925'],
             'image tag differs')
