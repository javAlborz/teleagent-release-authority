#!/usr/bin/python3 -I
"""Verify the exact v12 Teleagent release evidence before authority signing.
...
APP = '624dd11072efcf808be4f785ecd78bfea0334c61'
TREE = '6063f2452a12051f5fc8008d17129fcb47d9a206'
BUNDLE_SHA = '5db6f7f8dadc4ec9ea6d72ce56ce1fff362312e3b066b98d37c040805bdba3a1'
BUNDLE_SIZE = 840325120
MANIFEST_SHA = '4a0f8c09caf3965b707ffa4b0facf1d1c6ed53ad22a9bf049f341bfd7ac7ec37'
VOICE_SHA = '0bab3773a1b757bd04d303f57486e4dc4a5cc0f7c8bb436e34d961abf9066e38'
VOICE_CONFIG = 'sha256:204a335d8ff455bbaef778b8ef161b8b5c609a0c05b0eea2114dd7631c06a65f'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = '16243ccb3ce78e8d1f107ea4f5af39ec7fcdba5c7ee16a6f2c2ae39ef335b2a6'
SCAN_CHECK_SHA = 'b8235e2d9be0935dd3f9facb5addc6f7e0b6a64bbaacb49db4e88f5cf1f893cb'
DB_METADATA_SHA = '614768dfcc75dff52866587d425a5ef7c4803604bc662009e50b4fc61c147928'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v12-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36166521125,
    'voiceSbom': 36166753339,
    'bundle': 36166888721,
    'freshScan': 36166753327,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': 'd7e0c57cac97f1fbf4092edd17ac60cd1c77cc5b49330f96a1161e840a553094',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v12-voice-scan.py')
