#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v12 hosted voice image.
...
IMAGE_SHA256 = '0bab3773a1b757bd04d303f57486e4dc4a5cc0f7c8bb436e34d961abf9066e38'
APP_REVISION = '624dd11072efcf808be4f785ecd78bfea0334c61'
IMAGE_NAME = 'teleagent-v12-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v12-voice-diagnostic:20260925'],
             'image tag differs')
