#!/usr/bin/python3 -I
"""Verify the exact v13 Teleagent release evidence before authority signing.
...
APP = '1389d6e22e60481bf23f04078ff4d9f7ad233dd0'
TREE = '0cb07412ca1b34e4cc9ee19a06387804f1c4ac90'
BUNDLE_SHA = '96e22592d88178d52a673f53f03ae0cc8df7be21998ea7b58a4e42960c6cb43c'
BUNDLE_SIZE = 840325120
MANIFEST_SHA = '8540aadc98ccf2ba9c403ded28d64d34e58f2e344d91d390b2079049d1e5a5ce'
VOICE_SHA = '22d4fe82432efe230a176b4f4e6bb713913a394873bab717e92f22745f47ac19'
VOICE_CONFIG = 'sha256:dc3302f42c0080f5798b314ecc01543dafe43e25688af77ca80073ac129e8277'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = '781b0880037e8e9ca8eeb83284bbdd3726ccc25d948a03a6ec0c972d383dc8d4'
SCAN_CHECK_SHA = '8af3d2cc11f7c8c96cd3ddafc7dec6b6f5855d9140834edd1ff27c6c39b04ce6'
DB_METADATA_SHA = '174fcac287e8a129619f6e2052f05f2073dccc69e1f1252ad0ed6087cf0d57b0'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v13-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36171958593,
    'voiceSbom': 36172216023,
    'bundle': 36172357660,
    'freshScan': 36172215988,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': 'ecb28623c0f039f70ce5647c8306dc47810c2f98660699d528dfd5dab6dd5a19',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v13-voice-scan.py')
