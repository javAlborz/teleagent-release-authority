#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v13 hosted voice image.
...
IMAGE_SHA256 = '22d4fe82432efe230a176b4f4e6bb713913a394873bab717e92f22745f47ac19'
APP_REVISION = '1389d6e22e60481bf23f04078ff4d9f7ad233dd0'
IMAGE_NAME = 'teleagent-v13-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v13-voice-diagnostic:20260925'],
             'image tag differs')
