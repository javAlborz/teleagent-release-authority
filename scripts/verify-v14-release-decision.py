#!/usr/bin/python3 -I
"""Verify the exact v14 Teleagent release evidence before authority signing.
...
APP = '3b21fb828794446e82eb2553b2abdb614d43752c'
TREE = '57f8a5cb8b78c7836c47fa8338f7f3eeb3b65c2a'
BUNDLE_SHA = 'f067a7c04a2bda7016713b79cc49db08d2c4e880b290b1f67f0781c86c34d4d7'
BUNDLE_SIZE = 840325120
MANIFEST_SHA = 'adcbfe5c527edde14af65ea65097dec009011bff2c240d48288593628e8a8f06'
VOICE_SHA = '1699bff24dc75e9ffac538040b80b3195d8f6bab0b16593d32fac4bdd5e0f216'
VOICE_CONFIG = 'sha256:d4aedfcf20bf93a5a581639645408249fbd907b1f1d81ba660577ca94c010d3d'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = '293ad1e3b00cc56d70db0c3428dfbd4a804ac1784fecb487df53ff03ffc4f824'
SCAN_CHECK_SHA = 'ddac74ed1335371283073f1cd680496c9bd1082814ab8927fee984c58b636c9f'
DB_METADATA_SHA = '5a4b4d5d4eecb6518b9f56ebd5bd19ce69397845af1daad3ef6f5bbc08c3421b'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v14-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36175315726,
    'voiceSbom': 36175565289,
    'bundle': 36175716851,
    'freshScan': 36175565296,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': '514a0c4d2efae186f64b3aea1827ec4a6ea4670a8990157c75294e0eb17aa57b',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v14-voice-scan.py')
