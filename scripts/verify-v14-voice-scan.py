#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v14 hosted voice image.
...
IMAGE_SHA256 = '1699bff24dc75e9ffac538040b80b3195d8f6bab0b16593d32fac4bdd5e0f216'
APP_REVISION = '3b21fb828794446e82eb2553b2abdb614d43752c'
IMAGE_NAME = 'teleagent-v14-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v14-voice-diagnostic:20260925'],
             'image tag differs')
