#!/usr/bin/python3 -I
"""Verify the exact v15 Teleagent release evidence before authority signing.
...
APP = 'a0c6ff7aa6c20fcbe6c24b39338e04614a54d8d7'
TREE = '4742d2cb97b63440b06df0b98f93a47cc064b211'
BUNDLE_SHA = '31195220a1792d0675fd1c6ca8a5a142dd3501190329119021000678480f12de'
BUNDLE_SIZE = 840335360
MANIFEST_SHA = 'ce17261a197e5cce6699b826f4991dceb05e1bb4513d54a333daed54e2e8491a'
VOICE_SHA = 'a2f9feeb37f41317595f9d970ccf6d85cf34e9ab57ee274d547546884656b9ea'
VOICE_CONFIG = 'sha256:b60099195b3e8dd73ef6657810016ab35ac187e1998f13ebf7b6759a29ac7a9b'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = '68268f7d2a1052516597ee26215ffee610e9115a52769d60139493af59238596'
SCAN_CHECK_SHA = '7e7e992773fa0a1ec2806e9df9a4696f1e4e4acc87630d1652105696527559f9'
DB_METADATA_SHA = '93cae7be2d83370c8f3d8b8c7f5bc89d3a535a8014d9d235136a338ee115f486'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v15-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36181847659,
    'voiceSbom': 36181964729,
    'bundle': 36182129467,
    'freshScan': 36181964658,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': 'b3db91b939ffccb94b851d709d497797583126eb6681ec100d537611dfc83156',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v15-voice-scan.py')
