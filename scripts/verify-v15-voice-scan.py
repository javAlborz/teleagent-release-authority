#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v15 hosted voice image.
...
IMAGE_SHA256 = 'a2f9feeb37f41317595f9d970ccf6d85cf34e9ab57ee274d547546884656b9ea'
APP_REVISION = 'a0c6ff7aa6c20fcbe6c24b39338e04614a54d8d7'
IMAGE_NAME = 'teleagent-v15-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v15-voice-diagnostic:20260925'],
             'image tag differs')
