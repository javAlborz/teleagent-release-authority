#!/usr/bin/python3 -I
"""Verify the exact v16 Teleagent release evidence before authority signing.
...
APP = 'f4e563203a49ae5c70e5114a695a42b770b37f78'
TREE = '19c7f3dcaac8279bdf28fd8451cdf1d60bf02df2'
BUNDLE_SHA = '98a044d8aefa8c2684a4a67735d4827d801dfc8c5ec3ab039bea6e95845d15b4'
BUNDLE_SIZE = 840335360
MANIFEST_SHA = '8580b7ac195cb3cf6a1cf57787b21364b3daa537625ef4fedb557358195189be'
VOICE_SHA = '0462bf09bcff9178711291baf4bea8165e426b5263bf092d26429fee9f4dbe73'
VOICE_CONFIG = 'sha256:47543286b3e600cf111efc55c3cb73025651eb69a21e658a36f8ca0054a04877'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = 'eaeb8cf1e26c0dff2025c812fbf36924e2d365744a3fa939e6c159c8e8f00964'
SCAN_CHECK_SHA = '933324d2adaf8e06cc77d87a869840c2bc27f944a9787f04a2216385b59eb738'
DB_METADATA_SHA = '6ac3113781d5aa99ec805a70bb202ea91068d0889b5a50627c9903383568119d'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v16-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36228968104,
    'voiceSbom': 36229063469,
    'bundle': 36229164974,
    'freshScan': 36229115594,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': '9ced7087a97cb456e472cb0785f0f2a71d7ba1efacbfb3fe054998b26fa9de82',
        'glibcTarSha256': '3001c2ffb4f6cfda7032ee7a3dda684fcae0991860491be38e205bdf51e5f10a',
        'hostDependencyFiles': 4508, 'sourceEntries': 606,
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v16-voice-scan.py')
