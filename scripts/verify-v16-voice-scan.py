#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v16 hosted voice image.
...
IMAGE_SHA256 = '0462bf09bcff9178711291baf4bea8165e426b5263bf092d26429fee9f4dbe73'
APP_REVISION = 'f4e563203a49ae5c70e5114a695a42b770b37f78'
IMAGE_NAME = 'teleagent-v16-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v16-voice-diagnostic:20260926'],
             'image tag differs')
