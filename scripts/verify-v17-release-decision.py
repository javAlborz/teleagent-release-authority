#!/usr/bin/python3 -I
"""Verify the exact v17 Teleagent release evidence before authority signing.
...
APP = '442e63facdd8affe20fd26161b70c648982d1002'
TREE = '2137ef3f3c6a33997c6fe14c5a56659f390084e6'
BUNDLE_SHA = '222e63a88849d81f9fda755076a91fde44e10711972c1806bbf0b1a8f9b06b9b'
BUNDLE_SIZE = 838000640
MANIFEST_SHA = '8cedf22bfdbb8df8072382f694c179247d69e1e09c2e108a816912da021b7fe6'
VOICE_SHA = 'daba27c806f9e66c3489fe0a1338f21a3756ccb5db508e861da3783e6a665019'
VOICE_CONFIG = 'sha256:463a8238a4c50d6a0e84fb4e52388c92c05f8f43b8a85042317016ecf2ccbf47'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = 'bb80311011401da3a95fa4b96c94bdc110880aee274edae3fbe0ed307dbb20e8'
SCAN_CHECK_SHA = '7b496dc531f423d5809930cbfa788ab7d75c0bf74b71922e46335f537842edcb'
DB_METADATA_SHA = 'b041dbe55cfbdcf4f25e9769fe114e2c9922572133ee71a5c1052fd2a60490da'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v17-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36232444816,
    'voiceSbom': 36232658164,
    'bundle': 36232777418,
    'freshScan': 36232720033,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': '62c1203d4a13f4398416d5bba97574983e0bfb2db2b6c3972692467e14f9fa13',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v17-voice-scan.py')
