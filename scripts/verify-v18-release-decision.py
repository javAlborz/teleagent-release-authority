#!/usr/bin/python3 -I
"""Verify the exact v18 Teleagent release evidence before authority signing.
...
APP = 'bd40b6b64e63fa42e43dee7df179555bd51645cc'
TREE = 'fb7c11a7a62f178547a042c86aba255ecbaf2790'
BUNDLE_SHA = '6dd882575c6e5028582f70578cbd4d3631119c758b8f560fe4f5df995f30b943'
BUNDLE_SIZE = 838000640
MANIFEST_SHA = '5d5673a35c06326f4a83522232097689f92285d21e0e152244aa4fb780bf852a'
VOICE_SHA = '79590ca7880df5c846758cd9208e236aff9829bdde348aee90b10326dee47e6b'
VOICE_CONFIG = 'sha256:4b7f57db3ccedb380679dadc4bfa6ed64884da8f156f1e8b8d6d0d4a76246199'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = '9830f6e6c935f1abc22237e14a057a4215fba79823afa6eace42d730bc20aa28'
SCAN_CHECK_SHA = 'f4e2ec5dc26ef9002ccef072e596be000268bef111612899632174c80723d489'
DB_METADATA_SHA = '76c7a740062edd4a0651d068d1403d5216b6aa0e8e25153130cf36ffbbcf6dfa'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v18-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36234372990,
    'voiceSbom': 36234514720,
    'bundle': 36234726369,
    'freshScan': 36234637681,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': '2c58ac40c656956e037d62508616f24a69bc0d7fb2091b6a9051f01ef6267ca2',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v18-voice-scan.py')
