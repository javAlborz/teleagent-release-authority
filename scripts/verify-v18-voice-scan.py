#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v18 hosted voice image.
...
IMAGE_SHA256 = '79590ca7880df5c846758cd9208e236aff9829bdde348aee90b10326dee47e6b'
APP_REVISION = 'bd40b6b64e63fa42e43dee7df179555bd51645cc'
IMAGE_NAME = 'teleagent-v18-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v18-voice-diagnostic:20260926'],
             'image tag differs')
