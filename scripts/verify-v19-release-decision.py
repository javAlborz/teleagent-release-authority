#!/usr/bin/python3 -I
"""Verify the exact v19 Teleagent release evidence before authority signing.
...
APP = '8485f8000ba986ebc53210350add23078d970931'
TREE = '8b91872efc76d56a0efafe17e8e1c3933708af5a'
BUNDLE_SHA = '9c5c75c58fa4ee8e5c64361623f095d415fa65691de19806bc0e3335871ecd54'
BUNDLE_SIZE = 838000640
MANIFEST_SHA = '2dafdca2b9da720ccf11dc8f2303b7efacd4c7d4f05375657d9a1ff467bddfaa'
VOICE_SHA = 'de739d7589b4b98a4534e1b9530752559b860b6895da2d968eaf74b2722015a5'
VOICE_CONFIG = 'sha256:9d344866ef4b3eb4b53b3b6a201bebd7fc423f5d6c35da1c50f163dd4c2f33c8'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = 'b5e04389899c401ba0bbf2bed4704df9c9865e78231081da997be8e1a5a9b768'
SCAN_CHECK_SHA = '49b1e463b4ae2b5a25729b4f8e9c6089cd85aa9c7adc8e18b1f8f3cd5ec18ca5'
DB_METADATA_SHA = '02b34d48561bfeedbf3986afe5698317617d27d5994972e9dec26aa67580ab2f'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v19-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36236783634,
    'voiceSbom': 36236876219,
    'bundle': 36237016226,
    'freshScan': 36236955958,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': '35513d70218822a7d08482c5cbb17fcaf19e4dbbb8a799f2e169c8ce92c96e45',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v19-voice-scan.py')
