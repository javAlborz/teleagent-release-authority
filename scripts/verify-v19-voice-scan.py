#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v19 hosted voice image.
...
IMAGE_SHA256 = 'de739d7589b4b98a4534e1b9530752559b860b6895da2d968eaf74b2722015a5'
APP_REVISION = '8485f8000ba986ebc53210350add23078d970931'
IMAGE_NAME = 'teleagent-v19-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v19-voice-diagnostic:20260926'],
             'image tag differs')
