#!/usr/bin/python3 -I
"""Verify the exact v20 Teleagent release evidence before authority signing.
...
APP = '13024c12acd8c4c13e3c30ad15caa9ced03a351c'
TREE = 'c0b4356f9f15d163800fc731af5d516a8ae6c287'
BUNDLE_SHA = '6f2d17ea23faf7e138cd514473eda58eef6f6866e172a0a1bf9f547f75815b82'
BUNDLE_SIZE = 838010880
MANIFEST_SHA = '37c9f19402c6559627086c8111de8511ec1c40941142d38e191dceef5422f128'
VOICE_SHA = '1d503eb187cdaf6daa281e37f10f343af815a9f217b28d47197fe9acd48d1b63'
VOICE_CONFIG = 'sha256:45b35528066be0efcf32fccfe9260fc3b25a27648e71da7f7e07bedb5766ad3b'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = 'fef5b6e5b4ce8df6545732e0a03a8c371e100b85bd3bce406cd1a97a9f8ec031'
SCAN_CHECK_SHA = 'fe95d7b63e6b514ed84b40c67223eee9babdf53f14aad6396d59919f9e1f641f'
DB_METADATA_SHA = '50edf1c2b1ddbca0ba8a66747efce095b5170a05f943c70cb72cfb940878bb66'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v20-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36239238395,
    'voiceSbom': 36239374559,
    'bundle': 36239600953,
    'freshScan': 36239491327,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': 'da99f369732174fd3c8f0ffa2dd118eaa62ec0d4abcde3c0ad3ad82ea27b0a0a',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v20-voice-scan.py')
