#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v20 hosted voice image.
...
IMAGE_SHA256 = '1d503eb187cdaf6daa281e37f10f343af815a9f217b28d47197fe9acd48d1b63'
APP_REVISION = '13024c12acd8c4c13e3c30ad15caa9ced03a351c'
IMAGE_NAME = 'teleagent-v20-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v20-voice-diagnostic:20260926'],
             'image tag differs')
