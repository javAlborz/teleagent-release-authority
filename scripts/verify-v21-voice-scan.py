#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v21 hosted voice image.
...
IMAGE_SHA256 = 'bb7350feec88f4319f5ef521ee32f2853108112e20ac506272fb8168da8bb3e6'
APP_REVISION = '067dd51e2acef87f5704e4945694f14bfbfaffcd'
IMAGE_NAME = 'teleagent-v21-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v21-voice-diagnostic:20260926'],
             'image tag differs')
