#!/usr/bin/python3 -I
"""Verify the exact v22 Teleagent release evidence before authority signing.
...
APP = 'd8ef1bdf60b48d393ed642305d92587dfa32e240'
TREE = '6ea68df4be14d9e7f4fbf0020c7cd6ec046f2a05'
BUNDLE_SHA = '2dccadaa91d4d13c5af66f98d73fe469332cb14c5b84517582aa755539332396'
BUNDLE_SIZE = 838021120
MANIFEST_SHA = '616c6920a2f33841f3a386f4c6419c311889bab4000b8063ef48f8bf3df40043'
VOICE_SHA = '3173728e7a25538c85462be5b3bce4aa8f660248558d18d2a40ec73321dcb74f'
VOICE_CONFIG = 'sha256:efab1f785e1c55d55c92081f641d4052bb6fefaaf38318410d0a23f15936db27'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = 'bd169c8eeba35ab9a55bd7fdf995d8e9376f7070e9b25318af4bf0d05e1ce2a5'
SCAN_CHECK_SHA = 'd63f1f43c97fd4e5d059524827e8bd6f94bb97bc004b479cad37648a1c5680e3'
DB_METADATA_SHA = '1b87e85004b62f44fe147d41481829bae9d149e991e49672716ec5d734c143ed'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v22-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36245076959,
    'voiceSbom': 36245199826,
    'bundle': 36245650870,
    'freshScan': 36245295660,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': '887f9d611007cae2c610ce09963331cbc49448ab7b446675277e76f364da35ea',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v22-voice-scan.py')
