#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v22 hosted voice image.
...
IMAGE_SHA256 = '3173728e7a25538c85462be5b3bce4aa8f660248558d18d2a40ec73321dcb74f'
APP_REVISION = 'd8ef1bdf60b48d393ed642305d92587dfa32e240'
IMAGE_NAME = 'teleagent-v22-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v22-voice-diagnostic:20260926'],
             'image tag differs')
