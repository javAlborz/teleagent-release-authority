#!/usr/bin/python3 -I
"""Verify the exact v23 Teleagent release evidence before authority signing.
...
APP = '2110e614c9050801b066e277fa69828b19bce094'
TREE = '01874ad5d798f04d4efede58a52cc0003729d399'
BUNDLE_SHA = '3e8ec67c3d3ab43e72146c00d5e2b4cf3d45d4dfc5caf0576f54cd186c9df7e8'
BUNDLE_SIZE = 838031360
MANIFEST_SHA = '9796beead4abe6f09345270bf61fc522a4964c30a41b3712fbe9dfab5fa5a42b'
VOICE_SHA = '1b1814aa21cd5a541b16cbefcc459a53260a064595b2a5cbf8cd7c7c8d904cce'
VOICE_CONFIG = 'sha256:a09684f7c1a74ef2fa32ca77ad43e2ae0543abdca45c950f1b265af2a5de541a'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = '4451acb5893215cfafc18960a1acb3a0a796040ee87b1e25ad905c09dfd3c274'
SCAN_CHECK_SHA = '63c129600d77bbd2d5df9bb300b2cacf26b80193edeecbe7f808874547281579'
DB_METADATA_SHA = 'de3c9b7227ec77818e1f065fa5ca55e4addebc26f23e41df6b0604538c438c9e'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v23-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36248979107,
    'voiceSbom': 36249108439,
    'bundle': 36249355631,
    'freshScan': 36249240193,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': 'f8c081d29f2d417252cb246bbdc08c502c8a6e610586545cb180568e21184684',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v23-voice-scan.py')
