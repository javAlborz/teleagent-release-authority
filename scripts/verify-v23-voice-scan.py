#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v23 hosted voice image.
...
IMAGE_SHA256 = '1b1814aa21cd5a541b16cbefcc459a53260a064595b2a5cbf8cd7c7c8d904cce'
APP_REVISION = '2110e614c9050801b066e277fa69828b19bce094'
IMAGE_NAME = 'teleagent-v23-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v23-voice-diagnostic:20260926'],
             'image tag differs')
