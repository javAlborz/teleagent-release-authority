#!/usr/bin/python3 -I
"""Verify the exact v24 Teleagent release evidence before authority signing.
...
APP = '0c1630f3bca6df97ed127c1eeae0d2df52307a3a'
TREE = 'e558a74a6890614dbaa7b6343cb605b7e9f2789b'
BUNDLE_SHA = '7df6a3d9ebe554637415cc7b0b06b0c6f85515c6d3afa8e1b0dbeb6e7a5824b1'
BUNDLE_SIZE = 895928320
MANIFEST_SHA = 'd554f28bc7b29583d1bc8214f84072a13c9b8db87c79ae59e283898828aa43d0'
VOICE_SHA = 'd8d00875934ee0a327e4ac7c6565f5dd12b5542c416cf0460d50bd707bb38bbb'
VOICE_CONFIG = 'sha256:19646fbf7348b0d6d7a98c5a0e72e7177fdf8bedc46c73f5cdaddcff9242f281'
PROVIDER_MANIFEST = 'sha256:3f75ef0c36f8e8c0131b725a3143458b83da954b6aebe253241cc05981273c8b'
SCAN_SHA = 'cb13004875f2e090905e736c0127d35043df5f72dac3fe216379247e6763644b'
SCAN_CHECK_SHA = '65a2602ae24781d8c13425c6557a9a503a1b93f24af8ddb0ebeed5c3a32f6e85'
DB_METADATA_SHA = 'adc5b143be17d329931dd74d083a5fc81e46a658f348ef1f9a4077dbb7391117'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v24-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36254101266,
    'voiceSbom': 36254236947,
    'bundle': 36254375400,
    'freshScan': 36254323465,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': '766cbc92d95bab324943bbae68a2700f5d044d997bed6a6321686f897e4c0a42',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v24-voice-scan.py')
