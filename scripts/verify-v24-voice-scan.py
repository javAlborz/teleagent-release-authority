#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v24 hosted voice image.
...
IMAGE_SHA256 = 'd8d00875934ee0a327e4ac7c6565f5dd12b5542c416cf0460d50bd707bb38bbb'
APP_REVISION = '0c1630f3bca6df97ed127c1eeae0d2df52307a3a'
IMAGE_NAME = 'teleagent-v24-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v24-voice-diagnostic:20260926'],
             'image tag differs')
