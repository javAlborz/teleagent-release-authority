#!/usr/bin/python3 -I
"""Verify the exact v25 Teleagent release evidence before authority signing.
...
BUNDLE_SHA = 'adc8702065221cd63271595c0db45efef3a071bb804a31b93bf663b9179529d8'
BUNDLE_SIZE = 895928320
MANIFEST_SHA = 'a6404b78dbcfe76a6db979c333eb9fbb04db3959085d6dbbede89d3e389b1569'
VOICE_SHA = '87d7b185bfd23177c923d19cb3ee07b769d600d493a48f616d9eca729000ff63'
VOICE_CONFIG = 'sha256:fdff464018b4a86f14081c2085685f226a2b029f797ab5861f9cbd83bfe82337'
PROVIDER_MANIFEST = 'sha256:3f75ef0c36f8e8c0131b725a3143458b83da954b6aebe253241cc05981273c8b'
SCAN_SHA = 'e92559887e860675a98d2255acb03f1bb8a127a29eae7ef92b2260e18d7a6ac6'
SCAN_CHECK_SHA = '8790f0f4cc2037cc8adc60597353ea351e5d5360faaa945abbe5b9a0b9766123'
DB_METADATA_SHA = '2f3010571a71ceed5e95df016a0a7d15ee6ed789e2d3321da86b9b810ffc90b5'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v25-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36257733893,
    'voiceSbom': 36257842254,
    'bundle': 36258068373,
    'freshScan': 36257932015,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': 'bce86d7e6ceae62527021ea734d38001fa7abc49f9141cbd660963840006854b',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v25-voice-scan.py')
