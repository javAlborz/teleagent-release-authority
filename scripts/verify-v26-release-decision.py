#!/usr/bin/python3 -I
"""Verify the exact v26 Teleagent release evidence before authority signing.
...
APP = 'b57cda524e6f36fa25c91e3fe35408176a1be887'
TREE = '4bfc13dee43e76050ba249cd4ef00067f99a251a'
BUNDLE_SHA = '29251656f547e1e2dd9b21971ab14d0ece021193cf101d9ed5f4cfbc7ec238b9'
BUNDLE_SIZE = 895928320
MANIFEST_SHA = '4f6e358ea1fbc52de7c1defd4c5c03f758a6ac38d3213fed8ae0aae5d83d4f1f'
VOICE_SHA = '230d17107cdd0a8e51358f0b6ddcdea67631a7bc36fa5a1b432255fd852dcd74'
VOICE_CONFIG = 'sha256:405c9e25a09c894c4b6847f5b307c2f03f2833ad347cc6626356d426f6301616'
PROVIDER_MANIFEST = 'sha256:3f75ef0c36f8e8c0131b725a3143458b83da954b6aebe253241cc05981273c8b'
SCAN_SHA = 'f9e5363f490ab7a66da4680926cc895d10a08b30f0b69bc6797fc29a3b736144'
SCAN_CHECK_SHA = '2a80b070878a5d5b236eea1db6dd46814bb998f5ae9ff4acea2a709828bef94a'
DB_METADATA_SHA = '92dedddeeca3407883aa42f01a9ca2d78ef444724e0dd18f16752560bc496aeb'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v26-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36260248815,
    'voiceSbom': 36260339919,
    'bundle': 36260463221,
    'freshScan': 36260424770,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': 'cba94b25f949b3df52b26e8241df74e89a1f5ad33819781e7449096d95954872',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v26-voice-scan.py')
