#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v26 hosted voice image.
...
IMAGE_SHA256 = '230d17107cdd0a8e51358f0b6ddcdea67631a7bc36fa5a1b432255fd852dcd74'
APP_REVISION = 'b57cda524e6f36fa25c91e3fe35408176a1be887'
IMAGE_NAME = 'teleagent-v26-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v26-voice-diagnostic:20260926'],
             'image tag differs')
