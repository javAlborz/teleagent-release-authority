#!/usr/bin/python3 -I
"""Verify the exact v27 Teleagent release evidence before authority signing.
...
APP = 'f4113fca8d5fcffa2f1aba5cd5f015b8725710af'
TREE = '08e7e953e5feafa2b03df9ff9b9aa90e03499aba'
BUNDLE_SHA = '541d80fadcf25e452e9e76ca1b3d65c6b0be76327341ecd846e67bfbafeaf06d'
BUNDLE_SIZE = 895938560
MANIFEST_SHA = '846c7ff283e43a16c12efaf59cfe860e4f1e1226feb14106d9dc074205447b5c'
VOICE_SHA = '4913a8b2750b228797ff87e2917b8c80fdeecf2fe1aa7666073e4a28cce9b48d'
VOICE_CONFIG = 'sha256:4513051ed00b36727adbfcb27e2c31c0493af5eb7fb6bd191d57e2ef83d8f860'
PROVIDER_MANIFEST = 'sha256:3f75ef0c36f8e8c0131b725a3143458b83da954b6aebe253241cc05981273c8b'
SCAN_SHA = '05da7081ff2e0764301dfaed298138c0be49a15c8c3ce28fff3ec935727f8b00'
SCAN_CHECK_SHA = 'bcd8bcdc8bbde71c1d076297cc6efd7fd67e2ca631491bb90a3f8db38c10326d'
DB_METADATA_SHA = '3177064b83b259721351d3a40052121752c4c3d09526bab69e15f56d019b3526'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v27-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36263230989,
    'voiceSbom': 36263342329,
    'bundle': 36263458514,
    'freshScan': 36263427371,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': 'ef4981528c56db1cd22ecf1a3064b444e04543272a2a7f404a0e42b0abfdb73c',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v27-voice-scan.py')
