#!/usr/bin/python3 -I
"""Verify the exact v28 Teleagent release evidence before authority signing.
...
APP = 'cc0de4f31dd1de55c587dd0ee7448847df870fc9'
TREE = '4a516d42a434c136242dffdff440e75f15a27d93'
BUNDLE_SHA = 'b169805f0133637de1acc6e73aaeb7de5dd3b7adc34be45ae455e27032452201'
BUNDLE_SIZE = 895938560
MANIFEST_SHA = 'da9ae597298da59c77b8c3f2dc1e580c833dfe42d67d7260f3e3c325ccaffbcf'
VOICE_SHA = 'a60c9ab191b3be36bba528b63d5c75b311a6bdf437ddb11294bd833ec19cb076'
VOICE_CONFIG = 'sha256:71fd3de8bcfce0476e5014e55fea70d1477e30dbcc539899c111cf8282635e89'
PROVIDER_MANIFEST = 'sha256:3f75ef0c36f8e8c0131b725a3143458b83da954b6aebe253241cc05981273c8b'
SCAN_SHA = '14dbb725a7c508fbec9b1d03ec7dcb3113f767c3c3957933c834fcd75a698a98'
SCAN_CHECK_SHA = '13815fca8bf0b52dcbcc5523783ffb6fc5b874655acd0bf3b8fbf758d943e0d8'
DB_METADATA_SHA = '703e14155519778451884c4be5a45145337a6568a8c358d6ae13b87063631749'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v28-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36271055964,
    'voiceSbom': 36271376124,
    'bundle': 36271566895,
    'freshScan': 36271472211,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': '58fe655a0bc79d483d340b582ac394aff8b2288271b281a1ed22899c561b5389',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v28-voice-scan.py')
