#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v28 hosted voice image.
...
IMAGE_SHA256 = 'a60c9ab191b3be36bba528b63d5c75b311a6bdf437ddb11294bd833ec19cb076'
APP_REVISION = 'cc0de4f31dd1de55c587dd0ee7448847df870fc9'
IMAGE_NAME = 'teleagent-v28-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v28-voice-diagnostic:20260926'],
             'image tag differs')
