#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v29 hosted voice image.
...
IMAGE_SHA256 = '115e12851a7a084c5f3ec1127e891e48a2f2665d5425a2e5a51118c537a041ff'
APP_REVISION = 'f50a02d0f76e2d20d82098c806965e602ee46130'
IMAGE_NAME = 'teleagent-v29-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v29-voice-diagnostic:20260926'],
             'image tag differs')
