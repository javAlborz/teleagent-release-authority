#!/usr/bin/python3 -I
"""Verify the exact v4 Teleagent release evidence before authority signing.
...
APP = 'f711007f9b71b83a721617d04118630253125afa'
TREE = 'afae577b0fead7346a8f5e6624e241e7d2c8b497'
BUNDLE_SHA = 'ff914903bf7e6876d2d34b960c0eec780870511934feac9bf9b6cdad3c2884b2'
BUNDLE_SIZE = 840314880
MANIFEST_SHA = 'b5e693bdfe6e5c4e066dff1d7970b62cbd98a818153c735759eea644c8e21f7a'
VOICE_SHA = '3edffe99446d2cea8e4a2e86eedf597d35ae8311bd9c61ba0c2606b67f53d791'
VOICE_CONFIG = 'sha256:b94ae7e81dd1b01df84c92785dd0c15992e881702dda920879edfe66721fac1b'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = '55102b79a8bc2368ddbeddd4f889424ba69325b5f07ba1137118c0109eb13256'
SCAN_CHECK_SHA = 'd0bf54092c351f8a88e2e49fb9feacd3d1c92d07f4d8d26824f9249e5bb5991f'
DB_METADATA_SHA = 'fec35f8f0041ca9aa0af9a7eceb6de62b82f8285f09cbfe59064a6b46237e8c0'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v4-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36125074642,
    'voiceSbom': 36125643036,
    'bundle': 36126039178,
    'freshScan': 36125643043,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': '22ca76d120f93e45071352d62c47e1a74d9bbce1245713d60a3b4674f5238fea',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v4-voice-scan.py')
