#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v4 hosted voice image.
...
IMAGE_SHA256 = '3edffe99446d2cea8e4a2e86eedf597d35ae8311bd9c61ba0c2606b67f53d791'
APP_REVISION = 'f711007f9b71b83a721617d04118630253125afa'
IMAGE_NAME = 'teleagent-v4-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v4-voice-diagnostic:20260925'],
             'image tag differs')
