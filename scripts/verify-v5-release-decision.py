#!/usr/bin/python3 -I
"""Verify the exact v5 Teleagent release evidence before authority signing.
...
APP = 'a256435586df2c5a403e9cb9b5cde98eab498448'
TREE = 'dd695a2f7a9011ef42b48d433a923abf675644d7'
BUNDLE_SHA = '80a201ab03397f5e4b139a3bef448a214042e3d65428ceadb1351a8e282b9954'
BUNDLE_SIZE = 840314880
MANIFEST_SHA = 'e17bd5a9d6ecc552910f4470e88a0398c6bdbd9735e8db63d9b5d798eb4601de'
VOICE_SHA = 'b7882e453a4d5936f8b8e758c0822e099b6eedf41ef81edcd878da65cc96df2b'
VOICE_CONFIG = 'sha256:92f5334668950507c6be49ed3957f16653fa8e573931343164c2fbb0841b3c9b'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = '18b3e49bf8d93b2ed6eec72eca2ea646cdd1f3a165b79f8e2f69ec2154d57976'
SCAN_CHECK_SHA = '886ef4d93530b5bd43b40f906d25e041b73caeec759454a67f5213251e19020e'
DB_METADATA_SHA = 'ce9800b79236fcd0c882a2193a58f11c5cb692a34df672e3ef83d867fa9fd469'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v5-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36129165432,
    'voiceSbom': 36129347477,
    'bundle': 36129464123,
    'freshScan': 36129347423,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': '131bb2ff6c01f87467d0021a145a01ad93004e9a3bf74b8ac98e0736db79c87d',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v5-voice-scan.py')
