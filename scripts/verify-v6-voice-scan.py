#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v6 hosted voice image.
...
IMAGE_SHA256 = '5903f693e5aa135b80e54fedfdac6ce669938a6b00c4f235a7d8a29d1df39983'
APP_REVISION = '6ce710e13fffbe4d4407fc3326e8ed4bd7ff09c0'
IMAGE_NAME = 'teleagent-v6-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v6-voice-diagnostic:20260925'],
             'image tag differs')
