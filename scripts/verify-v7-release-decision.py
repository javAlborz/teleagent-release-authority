#!/usr/bin/python3 -I
"""Verify the exact v7 Teleagent release evidence before authority signing.
...
APP = 'a9c4ef96626a35d994b9f180d6029d411133ccbb'
TREE = 'e47f86be4e1953e5012c0119011f1bd70e1d0289'
BUNDLE_SHA = 'b3b2cbd823f4030a05020fa8bdef46e969a631cc81873ef59835cc8e5b2f2b24'
BUNDLE_SIZE = 840314880
MANIFEST_SHA = '1804c0c92c5d444458150b379399b4036842ea2cf66411756223fb2b031c3344'
VOICE_SHA = 'f5172e2e7103ab79b56e5017d4ee124d3e359bd68b0fe3132b67ada8987fb17a'
VOICE_CONFIG = 'sha256:e6cb0f7f60ffffb099c233c123edeeb74c030ce533472c2511b26cbcc17088bf'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = '244f5edf7cacac8eb32f0a339c111355b21d8f69f36a90c499e23d4156d6b382'
SCAN_CHECK_SHA = 'cc321a775e5c945f302b4961ea6c96df414bd70ad94b97138774132c359fb1b5'
DB_METADATA_SHA = 'fe5395e420a5b0a502d689cacee2927f598b67003c0e972f217f56fb415da126'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v7-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36139974497,
    'voiceSbom': 36140155362,
    'bundle': 36140277304,
    'freshScan': 36140155262,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': '6d6760ed3ed66a139e842b6b055fd136080564b7064d8c5c8fda5460f9d83c57',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v7-voice-scan.py')
