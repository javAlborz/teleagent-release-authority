#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v7 hosted voice image.
...
IMAGE_SHA256 = 'f5172e2e7103ab79b56e5017d4ee124d3e359bd68b0fe3132b67ada8987fb17a'
APP_REVISION = 'a9c4ef96626a35d994b9f180d6029d411133ccbb'
IMAGE_NAME = 'teleagent-v7-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v7-voice-diagnostic:20260925'],
             'image tag differs')
