#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v8 hosted voice image.
...
IMAGE_SHA256 = '9b13e1b08f7cc1c1f03aab252bf181548f7e44a0bf9d35fdc2bfd601baf01fa9'
APP_REVISION = '31d8b94138e5abcc696939b62f435f81abc07910'
IMAGE_NAME = 'teleagent-v8-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v8-voice-diagnostic:20260925'],
             'image tag differs')
