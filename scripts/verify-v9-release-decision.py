#!/usr/bin/python3 -I
"""Verify the exact v9 Teleagent release evidence before authority signing.
...
APP = 'e8a3e8d80f368e00f17d20524e319d0fc7d4187b'
TREE = '309374db64f7f661fe09c28d26b47f88981163d1'
BUNDLE_SHA = 'd5458a7c820b4d4ca7dd55090157cf0b16ff1192cf9f3cc615d17dbbe54c241d'
BUNDLE_SIZE = 840314880
MANIFEST_SHA = '01ec02959fac455549030f214f3c4d95f41a31646acbe18cb6b707c4018a328a'
VOICE_SHA = 'b7faf9e0464d914603585791450ca4ce1c8a639f3e3f0993b695b1e508da5063'
VOICE_CONFIG = 'sha256:ec5673e85e2b2f0ba2c6e52fcbacbe041ba03e1ead3172a380f1e17c2a0b8985'
PROVIDER_MANIFEST = 'sha256:b03031aa3bc6846cb63cf0fa17ae558fb93df9a2fad5b3fe6ce67ee7d24bbf04'
SCAN_SHA = '33fe4ad2d2366da516d8a89936ec1b224ca06d954cd5516e1d808f2cc3f1f428'
SCAN_CHECK_SHA = 'df9fdbb791a140b840e22c53d8b4ed6ad726dc60471091087a6c0a5af5f84083'
DB_METADATA_SHA = 'ac1bbdcda08ed27a864cdaf5b4423d6f3674f95acdb2dfc8ed3061b436c8ae2c'
AUTHORITY_REPO = 'javAlborz/teleagent-release-authority'
AUTHORITY_REPO_ID = '1383172221'
WORKFLOW = '.github/workflows/teleagent-v9-release-decision.yml'
...
SOURCE_RUNS = {
    ...
    'publicVoiceImage': 36150275650,
    'voiceSbom': 36150455047,
    'bundle': 36150620403,
    'freshScan': 36150455032,
}
...
def verify_summary(value):
    expected = {
        ...
        'voiceSbomSha256': '6201e7ce95eb59831272f4121aacd795e6a5d7a536262abc24b1a495bb6a9339',
...
def verify_scan(image, report, metadata, check, now):
    ...
    spec = importlib.util.spec_from_file_location(
        'teleagent_voice_scan_check', HERE / 'verify-v9-voice-scan.py')
