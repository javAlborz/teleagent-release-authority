#!/usr/bin/python3 -I
"""Bind a fresh Trivy report to the fixed unsigned v9 hosted voice image.
...
IMAGE_SHA256 = 'b7faf9e0464d914603585791450ca4ce1c8a639f3e3f0993b695b1e508da5063'
APP_REVISION = 'e8a3e8d80f368e00f17d20524e319d0fc7d4187b'
IMAGE_NAME = 'teleagent-v9-voice-image.docker.tar'
...
def verify(image, report_path, metadata_path, now):
    ...
    with tarfile.open(image, 'r:') as archive:
        ...
        need(type(manifest) is list and len(manifest) == 1 and
             manifest[0].get('RepoTags') == ['teleagent-v9-voice-diagnostic:20260925'],
             'image tag differs')
