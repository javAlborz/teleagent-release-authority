#!/usr/bin/python3 -I
"""Bind a Trivy diagnostic report to the fixed unsigned voice image.
...
IMAGE_SHA256 = '3d8aa6bf1509f45cbe2dc78a2679b3a16b14fe4043749920c9a864c0b6026e01'
APP_REVISION = '4279253269c71acfda20916707d26b4e51591c16'
...
def verify(image, report_path, metadata_path, now):
    ...
    for row in results:
        need(type(row) is dict and type(row.get('Packages')) is list and
             len(row['Packages']) > 0 and not row.get('Vulnerabilities'),
